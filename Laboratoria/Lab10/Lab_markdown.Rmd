...
Wykorzystując informacje przekazane na zajęciach i dodatkowych źródeł

- [cheatsheet](https://www.rstudio.com/resources/cheatsheets/), 
- [książka](https://bookdown.org/yihui/rmarkdown/html-document.html), 

zaproponuj jak zmodyfikować raport żeby łatwiej było z niego korzystać.
...
Argument `params` w YAML metadata - [więcej](https://bookdown.org/yihui/rmarkdown/parameterized-reports.html)
