...
introduction <- tabItem(
  ...
  fluidRow(
    class = "text-center",
    box(h1("Forests", style = "font-size:30px;font-weight:bold;font-family:Times New Roman"),
        width = 12
    )
  ),
  fluidRow(
    ...
    box(width = 4,
        height = 150,
        h1("60,082", style = "font-size:30px;font-family:Times New Roman;font-weight:bold"),
        h5("The GlobalTreeSearch database reports the existence of 60,082 tree species.", 
           style = "font-family:Times New Roman")),
  box(width = 4,
      height = 150,
      h1("5,000,000", style = "font-size:30px;font-family:Times New Roman;font-weight:bold"),
      h5("Every year the world loses around 5 million hectares of forest. 95% of
          this occurs in the tropics.", 
         style = "font-family:Times New Roman")),
  box(width = 4,
      height = 150,
      h1("90%", style = "font-size:30px;font-family:Times New Roman;font-weight:bold"),
      h5("Of the people living in extreme poverty, over 90 percent are dependant 
         on forests for at least part of their livelihoods.", 
         style = "font-family:Times New Roman"))
  ),
  fluidRow(
    box(width = 12,
        h5("This dashboard deals with the topic of forests, trying to draw attention to the 
...
worldmap <- tabItem(
  ...
  fluidRow(
    box(width = 12,
      h5("This interactive map shows the share of total land area that is
  ...
  fluidRow(
    ...
    box(width = 4,
          ...
          h5("We see that, in 2020, South America had the greatest share of global
...
deforastation <- tabItem(
  ...
  fluidRow(
    box(width = 12,
      h5("The plot shows the drivers of deforestation. You can select each driver on 
  ...
  fluidRow(
    ...
    box(width = 4, 
        h5("From this plot, we would conclude that the dominant drivers of deforestation 
...
woodproduction <- tabItem(
  ...
  fluidRow(
    box(h5("The charts below show the production of different categories of wood 
  ...
  column(9,
    fluidRow(
      box(
        plotlyOutput("plot_m3", height = 280),
        width = 8,
        height = 300,
      ),
      box(
  ...
  fluidRow(
    box(
      plotlyOutput("plot_tonnes", height = 280),
      width = 8,
      height = 300
    ),
    box(
  ...
  fluidRow(
    column(3,
      box(width = 12,
         h5("In the charts, we can see that the forestry production has generally increased 
